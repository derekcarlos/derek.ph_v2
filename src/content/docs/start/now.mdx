...
I finally bought the Wahoo Kickr Core 2.

I have been meaning to get this trainer ever since I started doing indoor workouts. I was using a used ThinkRider X7 Pro and its power accuracy changes over the course of the workout probably due to temperature change. For example, if at the start of the workout I can produce 85w with 80rpm of cadence, I will have to do 85-90rpm of cadence on the same workout and gear ratio.

I've been using this Kickr Core 2 for a few times now since its delivery and just today after doing a VO2 Max workout I don't see the power drift that I get from X7 (in both cases I am on resistance mode). I ordered some tennis balls with 3D print to get more comfortable on the saddle. I noticed that the 5-degree left-right shift in X7 pro is not available in Kickr Core 2 which makes me experience saddle discomfort almost immediately during the session.

Great value for money to those who wish to take their indoor sessions more seriously.

## October, 2025

I am finally dipping my toes into AI, after seeing how valuable it is in my workflow. My work would sometimes require me to parse through files, create new files from the information from those files, or even compare and analyze files. All these are done manually. While I can manually code my way through some of the stuff that I can automate, I still don't have the time to debug them if they fail.

Enter Claude AI. I was looking for a code-centric AI that can help me with this task. I used to use ChatGPT for my stuff, but based on experience it tends to disregard my instructions even if they are as clear as day. I tried Claude AI out and so far the codes I get are good with samples for each scenario, which is helpful because I tend to forget these scripts after a while and knowing how to use them when I revisit them is very much appreciated.

Now I can focus on my real work and have this handy guy who can help me as my sidekick. Nice.
