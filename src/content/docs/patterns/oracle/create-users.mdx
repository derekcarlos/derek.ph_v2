---
title: Create Users in WebLogic LDAP via WLST
description: A script to automate user creation and group assignment in Oracle WebLogic, eliminating manual errors and saving time.
---
...
```properties title="domain.properties"
