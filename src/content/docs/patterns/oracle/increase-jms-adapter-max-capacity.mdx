---
title: "How To Increase JMS Adapter Max Capacity"
description: "Adjusting the JMS Adapter's Max Capacity is crucial when scaling managed servers in Oracle SOA Suite to prevent resource pool limits from blocking connections"
---
