---
title: How to Perform Silent Installation of WebLogic 12c
description: Installing WebLogic 12c in silent mode for a remote Coherence test—ditching the slow X11 wizard for a fast, command-line solution.
---
...
```properties title="/u01/silent-weblogic.rsp"
[ENGINE]
